...
file <- "2024-06-23_144346_2050_summary_countries.csv"
...
save_path <- paste(save_dir, "scatter_cba_renovation.png", sep = "/")

x_column <- "shortname"
y_column <- "value"
color_column <- "color"
y_label_suffix <- "€"
y_label <- "Social cost-benefits (€/hh/year)"
...
save_path <- paste(save_dir, "scatter_electricity_renovation.png", sep = "/")
...
save_path <- "maps_countries_policy_mix_first_best_scenario.png"
...
save_path <- "maps_countries_policy_mix_second_best.png"
make_national_policy_mix(df, scenario, save_path)
