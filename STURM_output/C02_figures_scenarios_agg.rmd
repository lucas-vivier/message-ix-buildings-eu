...
scenarios <- c(
    ...
    "EU_carbon_tax_rebates" = "Carbon tax lump-sum",
    "EU_carbon_tax_rebates_q1" = "Carbon tax low-income",
    "EU_carbon_tax_heat_pump" = "Carbon tax subsidies",
    "EU_carbon_tax_dual" = "Carbon tax dual"
)
scenarios <- c(
    "EU" = "Current policies",
    "EU_reno" =  "Reno",
    "EU_reno_lowincome" =  "Reno lowincome",
    "EU_reno_performance" =  "Reno performance",
    "EU_reno_all" =  "Reno all",
    "EU_reno_all_lowincome" =  "Reno all lowincome",
    "EU_reno_all_performance" = "Reno all performance"
)
  scenarios <- c(
    "EU" = "Current policies",
    "EU_reno" = "Reno non-coordinated",
    "EU_reno_endogenous" = "Reno coordinated",
    "EU_reno_lowincome" = "Reno low-income",
    "EU_reno_performance" = "Reno performance",
    "EU_deep_reno" = "Deep renovation",
    "EU_carbon_tax" = "Carbon tax",
    "EU_carbon_tax_dual" = "Carbon tax dual",
    "EU_carbon_tax_rebates" = "Carbon tax rebates",
    "EU_mix" = "Base Mix",
    "EU_mix_enhance" = "Enhanced Mix"
)
...
sub_scenarios <- c(
    ...
    "Carbon tax lump-sum" = "Carbon tax lump-sum",
    "Carbon tax low-income" = "Carbon tax low-income"
)
...
sub_scenarios <- c(
    ...
    "Reno" = "Reno",
    "Reno all" = "Reno all",
    "Reno lowincome" = "Reno lowincome",
    "Reno performance" = "Reno performance",
    "Reno all lowincome" = "Reno all lowincome",
    "Reno all performance" = "Reno all performance"
)
sub_scenarios <- c(
    "Current policies" = "Current policies",
    "Reno" = "Reno",
